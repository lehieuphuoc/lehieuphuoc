						...
						<div class="blog-section row">
							<div class="col-md-6 col-lg-4">
								<article class="post">
									...
									<div class="post-body">
										<h2 class="post-title">
											<a href="<?=BASE_URL?>/single">Top New Collection</a>
										</h2>
										...
										<a href="<?=BASE_URL?>/single" class="post-comment">0 Comments</a>
									</div><!-- End .post-body -->
								</article><!-- End .post -->
							</div>
							<div class="col-md-6 col-lg-4">
								<article class="post">
									...
									<div class="post-body">
										<h2 class="post-title">
											<a href="<?=BASE_URL?>/single">Fashion Trends</a>
										</h2>
										<div class="post-content">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras non
												placerat mi.
							...
							<div class="col-md-6 col-lg-4">
								<article class="post">
									...
									<div class="post-body">
										<h2 class="post-title">
											<a href="<?=BASE_URL?>/single">Etiam laoreet sem</a>
										</h2>
										<div class="post-content">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras non
												placerat mi.
							...
							<div class="col-md-6 col-lg-4">
								<article class="post">
									...
									<div class="post-body">
										<h2 class="post-title">
											<a href="<?=BASE_URL?>/single">Perfect Accessories</a>
										</h2>
										<div class="post-content">
